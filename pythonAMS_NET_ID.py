...
#, plc_port= 851
#variable_name = "GvlInputs.general.iInt"
def open_connection():
...
def real_value_of_cpu_Usage(interval_s = 0.1):
    plc_address = "192.168.17.156.1.1" #plc_address_input.get()
    plc_port = int(851)
...
if __name__ == "__main__":
    ...
    write_value_button = customtkinter.CTkButton(master=root_tk, text="Write value", corner_radius=10, command=write_data_to_variable)
    write_value_button.place(relx=0.865, rely=0.3)
